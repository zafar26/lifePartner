...
export default function ResetPass({ navigation }) {
    ...
    return (
        <View style={styles.container}>
            ...
            <View>
                <Text style={styles.tex}>E-mail address verified! Set a new password</Text>
            </View>
            <View style={styles.inp}>
                <Text style={styles.tex}> New PassWord</Text>
                <input
                    type="password"
            ...
            <View style={styles.inp}>
                <Text style={styles.tex}>Re-Enter PassWord</Text>
                <input
                    type="password"
                    style={{ height: 40, borderColor: 'gray', borderWidth: 1, color: "white", backgroundColor: "#00001F" }}
